...
// Stack enumerations, and every constant name matches the C++ edition of this
// file (common/CASBACnetStackExampleConstants.h in the -CPP examples) so the
// two languages diff 1:1. Add more as your own project needs them.
// =============================================================================
...
export const OBJECT_TYPE_ANALOG_OUTPUT = 1;
export const OBJECT_TYPE_ANALOG_VALUE = 2;
export const OBJECT_TYPE_BINARY_INPUT = 3;
export const OBJECT_TYPE_BINARY_OUTPUT = 4;
export const OBJECT_TYPE_DEVICE = 8;
export const OBJECT_TYPE_MULTI_STATE_INPUT = 13;
export const OBJECT_TYPE_MULTI_STATE_OUTPUT = 14;
export const OBJECT_TYPE_NOTIFICATION_CLASS = 15;
...
export const PROPERTY_IDENTIFIER_LOCATION = 58;
...
export const PROPERTY_IDENTIFIER_MAC_ADDRESS = 423;
export const PROPERTY_IDENTIFIER_NUMBER_OF_STATES = 74;
export const PROPERTY_IDENTIFIER_OBJECT_IDENTIFIER = 75;
export const PROPERTY_IDENTIFIER_OBJECT_NAME = 77;
export const PROPERTY_IDENTIFIER_OBJECT_TYPE = 79;
...
export const PROPERTY_IDENTIFIER_PRIORITY_ARRAY = 87;
export const PROPERTY_IDENTIFIER_RELINQUISH_DEFAULT = 104;
export const PROPERTY_IDENTIFIER_CURRENT_COMMAND_PRIORITY = 431;
export const PROPERTY_IDENTIFIER_REFERENCE_PORT = 483;
export const PROPERTY_IDENTIFIER_STATE_TEXT = 110;
export const PROPERTY_IDENTIFIER_STATUS_FLAGS = 111;
export const PROPERTY_IDENTIFIER_SYSTEM_STATUS = 112;
...
export const ENGINEERING_UNITS_PERCENT = 98;
...
export const SERVICE_ACKNOWLEDGE_ALARM = 0;
export const SERVICE_CONFIRMED_EVENT_NOTIFICATION = 2;
export const SERVICE_READ_PROPERTY = 12;
export const SERVICE_READ_PROPERTY_MULTIPLE = 14;
export const SERVICE_WRITE_PROPERTY = 15;
export const SERVICE_WRITE_PROPERTY_MULTIPLE = 16;
export const SERVICE_DEVICE_COMMUNICATION_CONTROL = 17;
export const SERVICE_REINITIALIZE_DEVICE = 20;
export const SERVICE_I_AM = 26;
export const SERVICE_I_HAVE = 27;
export const SERVICE_UNCONFIRMED_EVENT_NOTIFICATION = 29;
export const SERVICE_TIME_SYNCHRONIZATION = 32;
export const SERVICE_WHO_HAS = 33;
export const SERVICE_WHO_IS = 34;
export const SERVICE_UTC_TIME_SYNCHRONIZATION = 36;
export const SERVICE_GET_EVENT_INFORMATION = 39;
...
export const READ_PROPERTY_SERVICE_TYPE = 12; // ReadProperty
export const READ_PROPERTY_MULTIPLE_SERVICE_TYPE = 14; // ReadPropertyMultiple
export const WRITE_PROPERTY_SERVICE_TYPE = 15; // WriteProperty

// -- BACnet application datatype tags ---------------------------------------
//    Full list: submodules/cas-bacnet-stack/source/BACnetStackDatatypes.h
export const BACNET_DATATYPE_REAL = 4;
...
export const DCC_ENABLE = 0; // resume all communication
export const DCC_DISABLE = 1; // stop initiating AND responding
export const DCC_DISABLE_INITIATION = 2; // keep responding, stop initiating

// -- ReinitializeDevice states (DM-RD-B) ------------------------------------
//    Full list: submodules/cas-bacnet-stack/source/BACnetReinitializedStateOfDevice.h
export const REINITIALIZE_STATE_COLDSTART = 0;
export const REINITIALIZE_STATE_WARMSTART = 1;

// -- Notification type (for alarm/event objects) ----------------------------
//    Full list: submodules/cas-bacnet-stack/source/BACnetNotifyType.h
export const NOTIFY_TYPE_ALARM = 0;
export const NOTIFY_TYPE_EVENT = 1;

// -- BACnet error codes (Error_Code enumeration) ----------------------------
//    Full list: submodules/cas-bacnet-stack/source/BACnetErrorCode.h
//    A SetProperty* callback writes one of these to its errorCode out-Buffer
//    (errorCode.writeUInt32LE(code, 0)) and returns false to reject a write
//    with that BACnet Error-PDU.
export const ERROR_CODE_PASSWORD_FAILURE = 26;
export const ERROR_CODE_VALUE_OUT_OF_RANGE = 37;
export const ERROR_CODE_OPTIONAL_FUNCTIONALITY_NOT_SUPPORTED = 45;
...
export const NETWORK_TYPE_IP = 0;
...
export const NETWORK_NUMBER_QUALITY_LEARNED = 1;
export const NETWORK_NUMBER_QUALITY_LEARNED_CONFIGURED = 2;
export const NETWORK_NUMBER_QUALITY_CONFIGURED = 3;
